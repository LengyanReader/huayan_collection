...
- 所有内容/进度/原则详见下方文档索引与「内容采集与编务总则」八条，**新会话先读 [`harness/README.md`](harness/README.md)（智能体工作法总纲·标准节拍）即可接续**
