...
- **当前下一步（见计划待续梯队）**：①人员数据深化——17 条 no_dates person 保持留空〔待核〕（世亲/支娄迦谶/般若/胜友/智军等古代译师无个人生卒可考、燃灯佛/迦叶佛/毗卢遮那佛/六师外道等神话·集体人物本无年代）；`verified=0` 已由 41→23（㉗ 回填 18 条），余 23 条为菩提流支/大华严寺瑜伽行法脉/当代学者/日韩系等，无力考者保持 0+注明；name_sa 65 缺中多为中文/日系人名本无梵文名（〔待核〕留空），仅个别经名化人物待对准（如慧果等密教灌顶名）；②`import_chapters` 非幂等已于㉖修复（OR REPLACE，重导入已验证通过）；Tab2-6/article.js 已证实数据驱动无 stray 硬编码
