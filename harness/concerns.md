...
| 落于 | 现有资产 | 〔缺口〕 |
|---|---|---|
| 主 C-D | L.㊽ **文体凡例八条**（章节落事实不收格言、加粗只留表格、段落参差、不用"首先/其次/最后"套话）· L.㊾ 语域学术化 + 文言残留归零 · 观点溯源七类标注（推论/评估/论证/主张/预测/立场/总结 + 逐条注依据）· `zh-academic-register` 技能 · GB/T 15835 数字规范 · 加粗密度指标（曾 10.97→9.50 每千字）· `citation-verification` · 论断强度校准（"决定"→"自然体现"） | [x] **已纳入 rules.md §I**（2026-09-26：文体凡例八条+观点溯源七类+论断强度校准已升格为常设规矩）<br>[ ] **无自动检查**：套话/加粗密度/文言残留/CJK-in-EN 泄漏——全靠人工回看<br>[ ] **EN 端文体规范**缺（中文有凡例，英文无）<br>[ ] 反幻觉的"不表演式坦白/不虚构细节"仅散在批次记录 |
