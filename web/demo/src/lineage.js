...
var ANIM_WAYPOINTS=[
  ...
  {y:-600,lat:34.0,lng:114.0,z:5,label:'老子·《道德经》',info:'老子(约前6世纪),道家学派创始人。著《道德经》五千言,以道法自然无为而治为核心。道家后与佛教般若学在魏晋深度融合,催生玄学。',src:'《史记·老子韩非列传》'},
  ...
  {y:-369,lat:33.5,lng:115.0,z:5,label:'庄子·逍遥游',info:'庄子(约前369-前286),战国道家代表。齐物坐忘与佛教空观禅修有精神亲缘,魏晋时与般若学融合为玄学。',src:'《史记·老子韩非列传》'},
  ...
  {y:-200,lat:34.0,lng:72.0,z:4,label:'希腊·犍陀罗佛教艺术萌芽',info:'希腊-巴克特里亚王国时期,佛教与希腊艺术在犍陀罗地区相遇。最早的佛像可能在此时期开始出现。',src:'佛教艺术史'},
...
function toggleAnim(){
  ...
  if(mapMini){
    ...
    animRouteLineU=L.polyline(routeCoords,{color:'#c46b5d',weight:2,opacity:0.6,dashArray:'4,6'}).addTo(mapMini);
