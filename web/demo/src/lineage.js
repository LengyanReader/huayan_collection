...
var ANIM_WAYPOINTS=[
  ...
  {y:-600,lat:34.0,lng:114.0,z:5,label:'☯老子·《道德经》',info:'老子(约前6世纪),道家学派创始人。据《史记》为周守藏室之史,居洛邑。后见周衰,西出函谷关,应关令尹喜之请著《道德经》五千言而去。',src:'《史记·老子韩非列传》'},
  {y:-570,lat:34.6,lng:112.4,z:5,label:'☯老子·周守藏室之史',info:'老子居洛邑任周王室守藏室之史(国家图书馆馆长)。在此期间博览典籍,形成其道法自然的哲学体系。',src:'《史记·老子韩非列传》'},
  {y:-551,lat:35.6,lng:116.9,z:5,label:'📖孔子诞生·鲁国陬邑',info:'孔子(前551-前479)生于鲁国陬邑(今山东曲阜)。父叔梁纥,母颜徵在。三岁丧父,家贫而好学。',src:'《史记·孔子世家》'},
  {y:-522,lat:35.6,lng:116.9,z:5,label:'📖孔子·三十而立·始教',info:'孔子约三十岁时开始授徒讲学,创办私学。主张有教无类,打破贵族对教育的垄断。',src:'《史记·孔子世家》'},
  {y:-497,lat:36.0,lng:117.0,z:5,label:'📖孔子·周游列国',info:'孔子55岁离开鲁国,开始14年周游列国之旅。先后至卫宋陈蔡等十余国,宣扬仁政德治,然终不见用。途中困于陈蔡之间,仍弦歌不辍。',src:'《史记·孔子世家》'},
  {y:-484,lat:35.6,lng:116.9,z:5,label:'📖孔子·归鲁删述六经',info:'68岁归鲁。整理《诗》《书》《礼》《乐》《易》《春秋》六经,为中国文化传承做出奠基性贡献。',src:'《史记·孔子世家》'},
  {y:-479,lat:35.6,lng:116.9,z:5,label:'📖孔子逝世·儒学历程开始',info:'73岁卒于鲁国。弟子编《论语》,儒学逐渐成为中华文明主流思想,后与佛教形成长达两千年的融突关系。'},
  {y:-372,lat:35.5,lng:117.0,z:5,label:'📖孟子·性善论',info:'孟子(约前372-前289),战国儒家代表。提出性善论仁政说。其心性之学后与佛教如来藏思想有深层对话空间。',src:'《史记·孟子荀卿列传》'},
  {y:-335,lat:36.0,lng:117.0,z:5,label:'📖孟子·游说齐梁',info:'孟子效法孔子周游列国,先后至齐梁等国宣扬仁政王道。齐宣王时曾为客卿,但主张终不见用。晚年退而与弟子万章等作《孟子》七篇。',src:'《史记·孟子荀卿列传》'},
  ...
  {y:-372,lat:35.5,lng:117.0,z:5,label:'📖孟子·性善论',info:'孟子(约前372-前289),战国儒家代表。提出性善论仁政说。其心性之学后与佛教如来藏思想有深层对话空间。',src:'《史记·孟子荀卿列传》'},
  {y:-369,lat:33.5,lng:115.0,z:5,label:'☯庄子·蒙地漆园吏',info:'庄子(约前369-前286)生于宋国蒙地(今豫皖交界)。曾任漆园吏,后弃官隐居。楚威王曾聘其为相,庄子笑拒:宁游戏污渎之中自快,无为有国者所羁。',src:'《史记·老子韩非列传》'},
  {y:-300,lat:33.5,lng:115.0,z:5,label:'☯庄子·著《南华真经》',info:'庄子晚年著书十万余言。《逍遥游》论精神自由,《齐物论》破主客二元,《养生主》说庖丁解牛。其坐忘心斋之说后与佛教禅观相通。',src:'《庄子》/《史记》'},
  {y:-313,lat:35.0,lng:116.0,z:5,label:'📖荀子·性恶论',info:'荀子(约前313-前238),战国儒家。性恶隆礼重法。其天人之分与佛教缘起论有可比较处。',src:'《史记·孟子荀卿列传》'},
  // 释迦生平
  ...
  {y:34,lat:32.0,lng:108.0,z:5,label:'☯张道陵诞生·沛国丰县',info:'张道陵(34-156),原名张陵,沛国丰县人(今江苏丰县)。早年通晓五经,后弃儒学道。',src:'《后汉书》《神仙传》'},
  {y:100,lat:30.0,lng:105.0,z:5,label:'☯张道陵·入蜀鹤鸣山',info:'张道陵入蜀至鹤鸣山(今四川大邑)。在此得太上老君亲授天师之位,创正一盟威之道(五斗米道)。',src:'《神仙传》'},
  {y:142,lat:30.5,lng:104.0,z:5,label:'☯张道陵·青城山·道教正式创立',info:'张道陵在青城山设二十四治(教区),正式建立天师道。奉老子为教祖,以《道德经》为根本经典,《老子想尔注》阐发教义。道教从此成为有组织的宗教。',src:'《后汉书·刘焉传》《神仙传》'},
  {y:156,lat:30.5,lng:104.0,z:5,label:'☯张道陵·飞升·系师张衡继任',info:'张道陵于青城山飞升(逝世),享年123岁。其子张衡继任为第二代天师(系师),孙张鲁为第三代天师,天师世家由此传承至今。',src:'《神仙传》《三国志·张鲁传》'},
  ...
  // 汉地·华严宗形成
  {y:320,lat:30.0,lng:115.0,z:5,label:'☯葛洪·《抱朴子》',info:'葛洪(283-363),晋代道教思想家。著《抱朴子》内篇系统阐述道教神仙理论。道教从此有了完整的理论体系。',bg:1,src:'《晋书·葛洪传》'},
  ...
  {y:800,lat:30.0,lng:112.0,z:5,label:'☯吕洞宾·道教内丹',info:'吕洞宾(约798-?),唐末五代道教宗师。后被尊为八仙之一。其内丹学说吸收佛教禅宗心性论,体现佛道深度融合。',bg:1,src:'道教神仙传'},
  ...
  {y:1050,lat:34.0,lng:113.0,z:5,label:'📖宋明理学兴起',info:'周敦颐(1017-1073)创太极图说,张载(1020-1077)立气论,二程(1032-1085)发明天理。理学吸收佛教心性论与华严理事无碍思维,开儒学新纪元。',src:'《宋史·道学传》'},
  ...
  {y:1200,lat:28.0,lng:118.0,z:5,label:'📖朱熹·理学集大成',info:'朱熹(1130-1200)集北宋理学大成,确立程朱理学体系。其格物穷理与华严事事无碍有可比较的认识论结构。朱子学后传入朝鲜日本,影响东亚思想史。',src:'《宋元学案》'},
  ...
  {y:1880,lat:34.0,lng:109.0,z:5,label:'☯陈撄宁·现代道教复兴',info:'陈撄宁(1880-1969),近代道教重要学者。创办《仙学》月刊,提倡仙学独立于儒释,推动道教的现代化转型。',bg:1,src:'中国道教史'},
  {y:1912,lat:34.5,lng:110.0,z:5,label:'☯张志顺·全真高道',info:'张志顺(1912-2015),全真龙门派第二十一代传人。以百岁高龄仍坚持修行传道,被认为是近代道家实修的典范人物。',bg:1,src:'道教人物志'},
  {y:1914,lat:31.7,lng:120.7,z:7,label:'华严大学·常熟兴福寺',info:'月霞创立近代第一所华严专宗教育机构。培养常惺/持松等现代学僧。'},
  {y:1936,lat:34.3,lng:108.9,z:5,label:'☯任法融·中国道协会长',info:'任法融(1936-2021),原中国道教协会会长。著《道德经释义》等,以现代语言诠释道家经典。推动道教与当代社会对话。',bg:1,src:'中国道教协会'},
...
function toggleAnim(){
  ...
  if(mapMain){
    ...
    animRouteLineM=L.polyline(routeCoords,{color:'#c46b5d',weight:3,opacity:0.5,dashArray:'8,6'}).addTo(mapMain);
    animRouteMarkerM=L.circleMarker([28,78],{radius:8,fillColor:'#c46b5d',color:'#ff6',weight:2,fillOpacity:0.9}).addTo(mapMain);
