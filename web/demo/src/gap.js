...
function renderGap(){
  ...
  h+="<div style='background:var(--card);border:3px solid #b8863c;border-radius:12px;padding:14px 20px;text-align:center;min-width:160px'><div style='font-weight:700;color:#b8863c'>六十华严</div><div style='font-size:0.72em;color:var(--text2)'>T09n0278 · 60卷34品</div><div style='font-size:0.68em;color:var(--text2)'>佛驮跋陀罗·420年</div></div>";
  ...
  h+="<div style='display:flex;align-items:center;color:#c0b098;font-size:1.2em'>→</div>";
  h+="<div style='background:var(--card);border:3px solid #b8863c;border-radius:12px;padding:14px 20px;text-align:center;min-width:160px'><div style='font-weight:700;color:#b8863c'>四十华严</div><div style='font-size:0.72em;color:var(--text2)'>T10n0293 · 40卷1品</div><div style='font-size:0.68em;color:var(--text2)'>般若·798年</div></div>";
  h+="<div style='display:flex;align-items:center;color:#c46b5d;font-size:1.2em'>⇢</div>";
  h+="<div style='background:var(--card);border:3px solid #c46b5d;border-radius:12px;padding:14px 20px;text-align:center;min-width:160px'><div style='font-weight:700;color:#c46b5d'>藏译华严</div><div style='font-size:0.72em;color:var(--text2)'>Toh44 · 4册45品</div><div style='font-size:0.68em;color:var(--text2)'>胜友/智军·9世纪</div></div>";
  h+="</div>";
  ...
  .forEach(function(b){h+="<span style='padding:4px 10px;background:rgba(94,139,158,0.08);border:1px solid rgba(94,139,158,0.3);border-radius:14px;font-size:0.73em'><b>"+b.t+"</b> <span style=color:var(--text2)>"+b.n+"</span><br><span style=font-size:0.85em;color:#5e8b9e>→ "+b.p+"</span></span>";});
  h+="</div></div>";

  // ── Related Sutras ──
  h+="<div class=section><h2>📎 眷属经（义理相关·非正部）</h2>";
  h+="<div style='display:flex;gap:8px;flex-wrap:wrap'>";
  [{t:'文殊师利发愿经',n:'T0296'},{t:'普贤菩萨行愿赞',n:'T0297·不空'},
   {t:'⭐ 大方广普贤所说经',n:'T0847·实叉难陀',note:'↔藏文普贤宣说品'},
   {t:'总持宝光明经',n:'T0299·法天'},{t:'不思议佛境界分',n:'T0300·提云般若'},
   {t:'如来不思议境界经',n:'T0301·实叉难陀'},{t:'度诸佛境界智光严经',n:'T0302·失译'},
   {t:'入如来德智不思议经',n:'T0303·阇那崛多'},{t:'大方广入如来智德',n:'T0304·实叉难陀'},
   {t:'信力入印法门经',n:'T0305·昙摩流支'},{t:'花严经修慈分',n:'T0306·提云般若'},
   {t:'庄严菩提心经',n:'T0307·鸠摩罗什'},{t:'大方广菩萨十地经',n:'T0308·吉迦夜'},
   {t:'最胜问十住除垢断结经',n:'T0309·竺佛念',note:'⚠法藏判非十住品'}]
  .forEach(function(r){h+="<span style='padding:4px 10px;background:rgba(125,154,110,0.08);border:1px solid rgba(125,154,110,0.3);border-radius:14px;font-size:0.73em'><b>"+r.t+"</b> <span style=color:var(--text2)>"+r.n+"</span>"+(r.note?"<br><span style=font-size:0.8em;color:#c46b5d>"+r.note+"</span>":"")+"</span>";});
  h+="</div></div>";

  // ── Treatises ──
  h+="<div class=section><h2>📖 论释</h2>";
  h+="<div style='display:flex;gap:10px;flex-wrap:wrap'>";
  h+="<span style='padding:6px 14px;background:rgba(196,107,93,0.08);border:1px solid rgba(196,107,93,0.3);border-radius:14px;font-size:0.78em'><b>十住毗婆沙论</b> <span style=color:var(--text2)>T1521·龙树造·鸠摩罗什译</span><br><span style=font-size:0.85em;color:var(--text2)>⚠ 虽名十住实释十地品·仅至二地</span></span>";
  h+="<span style='padding:6px 14px;background:rgba(196,107,93,0.08);border:1px solid rgba(196,107,93,0.3);border-radius:14px;font-size:0.78em'><b>十地经论</b> <span style=color:var(--text2)>T1522·世亲造·菩提流支译</span><br><span style=font-size:0.85em;color:var(--text2)>创新六相名相·催生地论师学派</span></span>";
  h+="<span style='padding:6px 14px;background:rgba(196,107,93,0.08);border:1px solid rgba(196,107,93,0.3);border-radius:14px;font-size:0.78em'><b>大乘起信论</b> <span style=color:var(--text2)>T1666·马鸣造[传统]</span><br><span style=font-size:0.85em;color:var(--text2)>法藏著义记为最权威注释之一</span></span>";
  h+="</div></div>";

  // ── Patriarch Commentaries ──
  h+="<div class=section><h2>📜 祖师核心章疏</h2>";
  h+="<div style='display:flex;gap:8px;flex-wrap:wrap'>";
  [{a:'杜顺',w:'华严法界观门·五教止观'},{a:'智俨',w:'华严经搜玄记·一乘十玄门'},
   {a:'法藏',w:'华严五教章·探玄记·金师子章·大乘起信论义记'},
   {a:'澄观',w:'华严经疏(60卷)·演义钞(90卷)·法界玄镜'},
   {a:'宗密',w:'禅源诸诠集都序·原人论·圆觉经大疏'},
   {a:'李通玄',w:'新华严经论(40卷)'},{a:'义天',w:'新编诸宗教藏总录(义天录)'}]
