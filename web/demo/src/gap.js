...
function renderGap(){
  ...
  [{a:'杜顺',dy:'557–640',ti:'华严初祖·帝心尊者(隋末唐初)',ws:[{t:'法界观门',u:'T45n1884'},{t:'五教止观',u:'T45n1867'},{t:'十门实相观'}]},
   {a:'智俨',dy:'602–668',ti:'华严二祖·至相尊者',ws:[{t:'搜玄记',u:'T35n1732'},{t:'孔目章',u:'T45n1870'},{t:'一乘十玄门',u:'T45n1868'},{t:'五十要问答',u:'T45n1869'}]}]
  .forEach(function(x){
  ...
  [{a:'法藏',dy:'643–712',ti:'华严三祖·贤首国师·实际创立者',ws:[{t:'五教章',u:'T45n1866'},{t:'探玄记',u:'T35n1733'},{t:'金师子章',u:'T45n1880'},{t:'华严经旨归',u:'T45n1871'},{t:'妄尽还源观',u:'T45n1876'},{t:'华严经问答',u:'T45n1873'},{t:'起信论义记',u:'T44n1846'},{t:'起信论别记',u:'T44n1845'},{t:'义海百门',u:'T45n1875'},{t:'华严经传记',u:'T51n2073'},{t:'心经略疏',u:'T33n1712'},{t:'法界无差别论疏',u:'T44n1838'},{t:'十二门论宗致义记',u:'T42n1826'},{t:'华严关脉义记',u:'T45n1872'}]},
   {a:'李通玄',dy:'635–730',ti:'枣柏大士·在家学者',ws:[{t:'新华严经论',u:'T36n1739'},{t:'决疑论',u:'T36n1741'}]},
   {a:'澄观',dy:'738–839',ti:'华严四祖·清凉国师·集大成者',ws:[{t:'华严经疏',u:'T35n1735'},{t:'演义钞',u:'T36n1736'},{t:'法界玄镜',u:'T45n1883'},{t:'三圣圆融观门',u:'T45n1882'},{t:'华严经略策',u:'T36n1737'},{t:'七处九会颂',u:'T36n1738'}]},
   {a:'宗密',dy:'780–841',ti:'华严五祖·圭峰大师·禅教融合',ws:[{t:'禅源诸诠集',u:'T48n2015'},{t:'原人论',u:'T45n1886'},{t:'圆觉经大疏',u:'X09n0243'},{t:'圆觉经略疏',u:'T39n1795',note:'⚠ 澄观亦有同名注疏(T35n1795)·归属存争议'},{t:'注法界观门',u:'T45n1884'},{t:'行愿品疏钞',u:'X05n0229'},{t:'盂兰盆经疏',u:'T39n1792'},{t:'禅门师资承袭图',u:'X63n1225'},{t:'金刚经疏论纂要',u:'T33n1701'}]}]
  .forEach(function(x){
    h+="<div class=pat-block><span class=pat-name>"+x.a+"</span> <span class=pat-info>"+x.dy+" · "+x.ti+"</span><div class=pat-works>";
    x.ws.forEach(function(w){h+="<span class=pat-wk>"+w.t+(w.u?" <a href='https://cbetaonline.dila.edu.tw/zh/"+w.u+"' target=_blank>📖</a> <a href='https://cbeta.buddhism.org.hk/xml/"+w.u+"_001.xml' target=_blank>📄</a>":"")+"</span>";});
    h+="</div></div>";
...
function renderAvatamsakaStudies() {
  ...
  if (avs.references) {
    h += '<div class=section id=avs-refs><h2>📚 参考文献</h2>'
       + (window.renderRefList ? renderRefList(avs.references, {md:true}) : '') + '</div>';
  }
...
function renderPanjiaoHupan() {
  ...
  if (pj.references) {
    h += '<div class=section><h2>📚 参考文献</h2>'
       + (window.renderRefList ? renderRefList(pj.references, {md:true}) : '') + '</div>';
  }
