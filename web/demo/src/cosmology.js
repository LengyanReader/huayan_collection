...
function renderCosmology(){
  ...
  h+="<iframe src='https://player.bilibili.com/player.html?bvid=BV1Jr421s7yH&page=1' style='width:100%;height:240px;border:none;border-radius:8px' allowfullscreen></iframe>";
  ...
  h+="<div style=flex:1;min-width:300px;background:var(--card);border:1px solid var(--line);border-radius:10px;padding:12px>";
  h+="<h4 style=color:var(--gold);margin-bottom:4px>🎧 普陀山梵呗·华严字母(官方音频)</h4>";
  h+="<p style=font-size:0.72em;line-height:1.8>一合·二合·三合及字母赞完整音频,普陀山佛教协会官方发布。</p>";
  h+="<p style=font-size:0.65em;margin-top:4px>🔗 <a href='https://www.putuo.org.cn/fyxlptfb/' target=_blank>普陀梵呗官网</a> · 🎬 <a href='https://www.youtube.com/results?search_query=%E5%8D%8E%E4%B8%A5%E5%AD%97%E6%AF%8D+%E6%A2%B5%E5%94%B1' target=_blank>YouTube</a> · <a href='https://www.bilibili.com/search?keyword=%E5%8D%8E%E4%B8%A5%E5%9B%9B%E5%8D%81%E4%BA%8C%E5%AD%97%E6%AF%8D' target=_blank>B站四十二字母</a></p></div></div>";
