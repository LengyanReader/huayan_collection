...
function renderPractice(){
  ...
  h+="<p style=font-size:.7em;color:var(--text2);margin-top:6px>📎 出处: 《观弥勒菩萨上生兜率天经》(六事法.持戒等为经文原说) . 海云继梦《华严学报》第3期(2012)提及弥勒相关论文参考 . 海云和上对弥勒内院的专门讲记目前公开可查资料较少,本节弥勒净土通用教义系依经文补充,非全部出自法师讲记</p>";
  h+="</div></div>";
  h+="</div>";
