...
function switchPracticeView(view,btn){
  ...
  // Re-render mermaid diagrams (hidden divs block initial render)
  setTimeout(function(){
...
function renderChanTraces() {
  ...
  h += '<div class=mermaid style="max-width:100%">\ngraph TD\n  BODHI["佛陀灵山拈花"] --> INDIA["印度二十八代"]\n  INDIA --> DAMO["菩提达摩(?-536)"\n  DAMO --> HUIKE["慧可(487-593)"\n  HUIKE --> SENGCAN["僧璨(?-606)"\n  SENGCAN --> DAOXIN["道信(580-651) 东山法门"]\n  DAOXIN --> HONGREN["弘忍(601-674)"\n  HONGREN --> SHENXIU["神秀(606-706) 北宗渐悟"]\n  HONGREN --> HUINENG["慧能(638-713) 南宗顿悟"]\n  HUINENG --> NANYUE["南岳怀让"]\n  HUINENG --> QINGYUAN["青原行思"]\n  NANYUE --> MAZU["马祖道一(709-788) 洪州宗"]\n  QINGYUAN --> SHITOU["石头希迁(700-790)"\n  MAZU --> LINJI["临济义玄 临济宗"]\n  SHITOU --> CAODONG["洞山良价 曹洞宗"]\n  MAZU --> WEIYANG["沩仰宗"]\n  SHITOU --> YUNMEN["云门文偃 云门宗"]\n  SHITOU --> FAYAN["法眼文益 法眼宗"]\n  LINJI --> DAHUI["大慧宗杲(1089-1163) 看话禅"]\n  CAODONG --> HONGZHI["宏智正觉(1091-1157) 默照禅"]\n  LINJI --> CHANJING["明清禅净合流"]\n  CHANJING --> XUYUN["虚云(1840-1959) 兼祧五宗"]\n  XUYUN --> JINGHUI["净慧(1933-2013) 生活禅"]\n  XUYUN --> BENHUAN["本焕"]\n  XUYUN --> FOYUAN["佛源"]\n</div>';
...
function renderChengguanSection() {
  ...
  h += '<div class=mermaid style="max-width:100%">\ngraph TD\n  subgraph A["天台宗 Tiantai"]\n    DX["谛闲大师"] --> XM["显明老和尚 天台45世"]\n    XM --> CG1["成观法师 天台46世 1988年纽约出家"]\n  end\n  subgraph B["真言宗 Shingon"]\n    KYS["高野山金刚峰寺"] --> CG2["成观法师 真言宗53世 传法灌顶阿阇梨 1996年"]\n  end\n  subgraph C["华严宗 Huayan"]\n    DS["杜顺至宗密五祖"] --> LJ["历代祖师"]\n    LJ --> CG3["成观法师 贤首宗42世 慈恩宗42世 2010年承接"]\n  end\n  CG1 --> JY["新逍遥园译经院 (1991 台北)"]\n  CG1 --> BZS["遍照寺 (美国密西根)"]\n  CG1 --> LY["楞严座主: 楞严经义贯上下"]\n  CG1 --> WS["唯识系列: 百法/三十论/八识"]\n  CG1 --> ZY["英译11种: 法华/楞严/金刚/坛经"]\n  CG1 --> ZM["真言密法: 汉传东密"]\n</div></div>';
