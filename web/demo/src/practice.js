...
function renderPractice(){
  ...
  +"<svg viewBox='0 0 720 130' style='max-width:100%;height:auto;margin:10px 0'><defs><linearGradient id='g1' x1=0 y1=0 x2=1 y2=0><stop offset=0% stop-color=#b8863c20/><stop offset=100% stop-color=#b8863c50/></linearGradient><linearGradient id='g2' x1=0 y1=0 x2=1 y2=0><stop offset=0% stop-color=#5e8b9e20/><stop offset=100% stop-color=#5e8b9e50/></linearGradient><linearGradient id='g3' x1=0 y1=0 x2=1 y2=0><stop offset=0% stop-color=#c46b5d20/><stop offset=100% stop-color=#c46b5d50/></linearGradient></defs>"
  +"<rect x=10 y=15 width=200 height=45 rx=8 fill='url(#g1)' stroke='#b8863c' stroke-width=1.5/>"
  +"<text x=110 y=35 text-anchor=middle font-size=13 font-weight=600 fill='#b8863c'>资粮道</text><text x=110 y=52 text-anchor=middle font-size=10 fill='#8a7060'>发心工程·居士阶段</text>"
  +"<text x=270 y=40 font-size=20 fill='#c0b098'>→</text>"
  +"<rect x=290 y=15 width=200 height=45 rx=8 fill='url(#g2)' stroke='#5e8b9e' stroke-width=1.5/>"
  +"<text x=390 y=35 text-anchor=middle font-size=13 font-weight=600 fill='#5e8b9e'>前行·正行</text><text x=390 y=52 text-anchor=middle font-size=10 fill='#6a7060'>内摄·等持·出家修道</text>"
  +"<text x=550 y=40 font-size=20 fill='#c0b098'>→</text>"
  +"<rect x=570 y=15 width=140 height=45 rx=8 fill='url(#g3)' stroke='#c46b5d' stroke-width=1.5/>"
  +"<text x=640 y=35 text-anchor=middle font-size=13 font-weight=600 fill='#c46b5d'>三摩地</text><text x=640 y=52 text-anchor=middle font-size=10 fill='#8a6060'>华严境界·海印三昧</text>"
  // Bottom arrows: samahita → samapatti → samadhi
  +"<text x=150 y=90 text-anchor=middle font-size=10 fill='#a09080'>三摩呬多(samāhita·等引)</text>"
  +"<text x=390 y=90 text-anchor=middle font-size=10 fill='#a09080'>三摩钵底(samāpatti·等持)</text>"
  +"<text x=640 y=90 text-anchor=middle font-size=10 fill='#a09080'>三摩地(samādhi·等至)</text>"
  +"<line x1=150 y1=75 x2=150 y2=82 stroke='#c0b098' stroke-width=1/>"
  +"<line x1=390 y1=75 x2=390 y2=82 stroke='#c0b098' stroke-width=1/>"
  +"<line x1=640 y1=75 x2=640 y2=82 stroke='#c0b098' stroke-width=1/>"
  +"</svg></div>"
