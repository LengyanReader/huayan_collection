...
function renderPractice(){
  ...
  var heartXRef={
    '别用大脑':{r1:'◆ <b>调身·调息·调心(五科训练)</b>: 海云和上《煖身:华严禅修入门》(布克文化2021)系统阐述调身七支坐相、调息息之四相、调心四相诊治。强调「身息心三者一体不二」——与本文「内脏内动」完全对应。<br>◆ <b>驻佇心观(停心工程)</b>: 《华严禅行法—禅观》第四集:「你要能够停下心来,然后我们要观心!停心是一个前行。」本文「不能用大脑」即停心的基本操作。<br>◆ <b>参禅金三角</b>: fjdh.cn(2013.12):「置心一处、放轻松、息入息出很清楚。」本文暖身二法的内脏内动正是金三角中「放轻松」的身体基础。<br><span class=src>📎 禅观法要→调身调息调心·驻佇心观·参禅金三角</span>',
      r2:'◆ <b>天台止观·调五事</b>: 智者大师《释禅波罗蜜次第法门》(CBETA T46n1916):「调身者,令身体不宽不急;调息者,令息不涩不滑;调心者,令心不沉不浮。」与本文三种调法异曲同工。<br>◆ <b>道家·庄子心斋</b>: 《庄子·人间世》:「若一志,无听之以耳而听之以心,无听之以心而听之以气。」「听之以气」即从思维转向身体感知——与本文「不能用大脑,用身体」思路一致。<br>◆ <b>瑜伽·Pratyahara(制感)</b>: Patanjali《瑜伽经》2.54-55: 感官从外境收摄向内,对应暖身二法将注意力从外境转向身体内部。<br><span class=src>📎 T46n1916 ·《庄子·人间世》·《瑜伽经》2.54</span>'},
    '四段呼吸':{r1:'◆ <b>安那般那数息观(数·随·止)</b>: 随法注意「息入尽」与「息出尽」每一细节。本文四段呼吸对应随法中对呼吸全过程的精细觉知。<br>◆ <b>息之四相</b>: 「息相」为无声不结不粗、出入绵密若存若亡的调相。四段呼吸的清晰觉知正是从「气相」趋入「息相」的关键。<br><span class=src>📎 禅观法要→安那般那·调息息之四相</span>',
      r2:'◆ <b>南传·安那般那念</b>: 《中部·安那般那念经》(MN 118):「念入息、念出息。入息长知入息长…」十六阶段的安般念隐含对呼吸各阶段的全面觉知。<br>◆ <b>道家·胎息</b>: 《抱朴子·内篇》:「得胎息者,能不以鼻口嘘吸,如在胞胎之中。」与息相「出入绵密若存若亡」相通。<br><span class=src>📎 MN 118 ·《抱朴子·释滞》</span>'},
    '闭气不是憋气':{r1:'◆ <b>参禅金钥匙·吸闭吐</b>: 第九讲中详述金钥匙——吸(自然吸气)→闭(自然停住,不憋气)→吐(自然呼气)。本文是金钥匙「闭」字的准确诠释。<br>◆ <b>数于尽处</b>: 在「息入尽」及「息出尽」的O点换气处数息。此O点即是自然闭气之处。<br><span class=src>📎 禅观法要→参禅金三角·技术面数随止</span>',
      r2:'◆ <b>瑜伽·Kumbhaka(住气)</b>: 《哈达瑜伽之光》2.44-47: Kevala Kumbhaka(无作住气)为自然的呼吸停止,非刻意憋气。与本文「自然闭气」一致。<br>◆ <b>道家·踵息</b>: 《庄子·大宗师》:「真人之息以踵,众人之息以喉。」闭气是深息的自然结果而非强制。<br><span class=src>📎 《哈达瑜伽之光》Ch.2 ·《庄子·大宗师》</span>'},
    '转折点':{r1:'◆ <b>工程面A阶段</b>: 双轨详解要求「对比感受呼吸长短的差异性,对呼吸的存在产生真切感受。」本文O点感知即A阶段具体操作。<br>◆ <b>参禅金三角·息入息出清楚</b>: 看清O点即是看得最清楚的时刻。<br><span class=src>📎 禅观法要→工程面A阶段·参禅金三角</span>',
      r2:'◆ <b>天台·六妙门之「止」</b>: 《六妙门》(T46n1917):「息诸缘虑,不念数随,凝寂其心。」止的入口即在息之转折——O点是最自然的「止」处。<br>◆ <b>道家·玄牝之门</b>: 《老子》第6章:「玄牝之门,是谓天地根。绵绵若存,用之不勤。」呼吸转折处如玄牝之门。<br><span class=src>📎 T46n1917 ·《老子》第6章</span>'},
    '呼吸里的一股力':{r1:'◆ <b>工程面B阶段·洞悉呼吸因果轨迹</b>: 「掌握此即长寿法基础,能自主生死——法师称此为生命的秘笈。」本文「息之力」即B阶段所述呼吸因果轨迹的内在动力。<br>◆ <b>般那不外漏</b>: 参禅金三角中留住生命能量(般那/Prana)不外泄。<br><span class=src>📎 禅观法要→工程面B阶段·参禅金三角(<a href=\"https://www.fjdh.cn/fjask/2013/12/133616318955.html\" target=_blank>fjdh.cn全文</a>)</span>',
      r2:'◆ <b>瑜伽·Prana(生命能量)</b>: 《泰迪黎亚奥义书》2.3: Prana为五种生命气息之首。本文「息之力」=Prana的直观感知。<br>◆ <b>道家·「炁」</b>: 《云笈七签》卷五十六:「炁者,天地之元,万物之始。」道家内丹的「炁」非呼吸之气而是生命能量。<br><span class=src>📎 《泰迪黎亚奥义书》·《云笈七签》</span>'},
    '置心一处':{r1:'◆ <b>置心一处·四种停心方法</b>: 《华严禅行法—禅观》:(1)参话头(2)置心风门(3)数息随息(4)依禅堂规矩。本文概为三大工程:调身(七支坐相)→调息(数息1-10)→调心(摄心于风门)。<br>◆ <b>内摄·内观·禅观三层功夫</b>: 内摄=技术面·摄心于息;置心一处是内摄核心。<br><span class=src>📎 禅观法要→驻佇心观·四种停心方法·三层功夫</span>',
      r2:'◆ <b>天台止观·系缘守境</b>: 《释禅波罗蜜》(T46n1916):「系心一处,无令散乱。」智者大师以五种系缘法与置心风门同为系缘一处。<br>◆ <b>禅宗·守一不移</b>: 《六祖坛经》(T48n2008):「一行三昧者,于一切处常行一直心是也。」<br><span class=src>📎 T46n1916 · T48n2008 · T48n2010(信心铭)</span>'},
    '心跑了':{r1:'◆ <b>内摄·技术面核心</b>: 「妄想一起,把心抓回来放在风门——心跑掉抓回来是一项大工程。」克服四种妄想(心理/物理/生理/社会制度)。<br>◆ <b>参禅金三角</b>: 「放轻松」中包含不跟妄想纠缠——「呼吸归呼吸,妄想归妄想。」<br><span class=src>📎 禅观法要→内摄·四种妄想·参禅金三角</span>',
      r2:'◆ <b>南传·正念标记法</b>: Mahasi Sayadaw内观法: 心散乱时标记「妄想、妄想」,温和地回到腹部起伏——与本文「不评判不懊恼」一致。<br>◆ <b>道家·庄子坐忘</b>: 《庄子·大宗师》:「堕肢体,黜聪明,离形去知,同于大通。」<br><span class=src>📎 Mahasi Sayadaw《实用内观禅修》·《庄子·大宗师》</span>'},
    '别躲清静':{r1:'◆ <b>依禅堂规矩</b>: 四种停心方法之四——「该动则动、该静则静,身心放下。」禅堂有动有静,非一味枯坐。<br>◆ <b>大脑临界点</b>: 跨过初果门槛后须弃用概念思维。日常防震训练即跨越临界点前的必要准备。<br><span class=src>📎 禅观法要→四种停心方法·三大关键原则</span>',
      r2:'◆ <b>禅宗·赵州茶</b>: 南泉普愿:「平常心是道。」赵州从谂:「吃茶去。」日用平常中修——正是本文「别躲清静」的精神源头。<br>◆ <b>大乘·维摩诘经</b>: (T14n0475):「不入烦恼大海,则不能得一切智宝。」在烦恼中修行,不避世间。<br><span class=src>📎 《临济录》·《赵州录》·T14n0475</span>'},
    '内动来了':{r1:'◆ <b>参禅金三角全程流程</b>: fjdh.cn全文——「调身→调息→置心一处→放松→息入息出清楚→金三角(心一境性)→触功德发起→内动→金钥匙→觉照根性→象限转移→破无明→入菩提道。」本文处于「内动→金钥匙」环节。<br><span class=src>📎 <a href=\"https://www.fjdh.cn/fjask/2013/12/133616318955.html\" target=_blank>fjdh.cn·参禅金三角全文</a></span>',
      r2:'◆ <b>瑜伽·Bandha(收束法)</b>: 《哈达瑜伽之光》3.55-60: 收束法在Kumbhaka时配合运用,引导Prana向上流动——与金钥匙的「闭→吐」能量引导类似。<br>◆ <b>道家·火候·进火退符</b>: 金钥匙「吸(进)→闭(炼)→吐(退)」与内丹火候的进-炼-退结构相似。<br><span class=src>📎 《哈达瑜伽之光》Ch.3 ·《周易参同契》</span>'},
    '入禅九阶':{r1:'◆ <b>体系总览·三阶段</b>: 资粮道(发心工程·驻佇心观)→前行(界内定·四种观法)→正行(界外定·等持工程)。入禅九阶:暖身至置心属资粮道,内动至入禅属前行。<br>◆ <b>三界定功总纲</b>: 欲界定(舍妄念)→色界定(舍五识)→无色界定(舍意识)→出界定。九阶对应欲界定的粗住→细住→欲界定全过程。<br><span class=src>📎 禅观法要→体系总览·三界定功总纲</span>',
      r2:'◆ <b>天台·六即佛</b>: 智者大师六即佛(理即→名字即→观行即→相似即→分证即→究竟即)为修行阶次经典框架。入禅九阶属「观行即」的实操展开。<br>◆ <b>道家·内丹九转</b>: 筑基→炼精化气→炼气化神→炼神还虚→炼虚合道。从身体入手(筑基),经气·神·虚·道层层升进——与九阶「身→息→心→禅」的进路结构对应。<br><span class=src>📎 CBETA T46n1912(六即)·《周易参同契》·《钟吕传道集》</span>'}
  };
  ...
  if(typeof HEART_ARTICLES!=='undefined' && HEART_ARTICLES.length>0){
    for(var hi=0; hi<HEART_ARTICLES.length; hi++){
      ...
      h+="<div class=h3col>"
        +"<div class=h3col-l><h3 style=color:var(--gold)>"+a.title+"</h3>"
        +"<p style=white-space:pre-line>"+a.body.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/\"/g,'&quot;')+"</p>"
        +"<p class=src>📎 <a href='https://mp.weixin.qq.com/s/S2D9BOc3jFwDRQr2tbzG6g' target=_blank>第1篇原文入口</a>(后续通过末尾「下一篇」依次访问) · 永远的犍陀罗·实修心要</p></div>"
        +"<div class=h3col-r1><h3 style=color:var(--gold)>📐 海云华严行法对照</h3><p>"+(xr?xr.r1:'(对照内容待补)')+"</p></div>"
        +"<div class=h3col-r2><h3 style=color:#5e8b9e>🔍 其他宗派/道家印证</h3><p>"+(xr?xr.r2:'(印证内容待补)')+"</p></div></div>";
    }
  }else{
