...
function renderPractice(){
  ...
  h+="<p style=font-size:.78em;color:var(--text2);line-height:1.7>来源: 微信公众号「永远的犍陀罗」· 实修心要专辑(共10篇)。海云继梦和上开示,仁悦整理。<b>左栏:全部原文 · 中栏:海云华严行法对照 · 右栏:其他宗派/道家相互印证。</b>全部内容可回溯至原文或经典出处。</p></div>";
...
function heartEdit(elId){
  ...
  if(el.contentEditable==='true'){
    ...
    el.focus();
    heartFlash(el,'✏️ 可编辑(Ctrl+Enter保存)');
