...
function renderPanjiaoSection() {
  ...
  // References
  if (pj.references) {
    h += '<div class=section style=margin-top:10px;font-size:0.72em><p style=font-size:0.7em;color:var(--text2)>📚 参考文献</p>'
       + (window.renderRefList ? renderRefList(pj.references) : '') + '</div>';
  }
  return h;
}
...
function renderXinfaSection() {
  ...
  if (xf.references) {
    ...
    xf.references.forEach(function(g) {
      h += '<p style=margin:4px 0><b>' + g.fmt + '</b></p>'
         + (window.renderRefList ? renderRefList(g.items, {legend:false}) : '');
    });
    h += '</details>';
  }
  return h;
...
function renderDushunSection() {
  ...
  if (dz.references) {
    h += '<details style=font-size:0.7em;margin-top:4px><summary>📚 参考文献 (' + dz.references.length + '条)</summary>'
       + (window.renderRefList ? renderRefList(dz.references) : '') + '</details>';
  }
  h += '</div>';
  return h;
}
...
function renderTiantaiSection() {
  ...
  if (tt.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献</summary>'
       + (window.renderRefList ? renderRefList(tt.references) : '') + '</details>';
  }
  return h;
}
...
function renderZhuandaoSection() {
  ...
  if (zz.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献 (' + zz.references.length + '条)</summary>'
       + (window.renderRefList ? renderRefList(zz.references) : '') + '</details>';
  }
  h += '</div>';
  return h;
}
...
function renderSanShiQiDaoPin() {
  ...
  if (sq.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献 (' + sq.references.length + '条)</summary>'
       + (window.renderRefList ? renderRefList(sq.references) : '') + '</details>';
  }
  h += '</div>';
  return h;
}
...
function renderVinayaSection() {
  ...
  // References
  if (vy.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献 (' + vy.references.length + '条)</summary>'
       + (window.renderRefList ? renderRefList(vy.references) : '') + '</details>';
  }
  return h;
}
...
function renderFaxiangSection() {
  ...
  if (fx.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献 (' + fx.references.length + '条)</summary>'
       + (window.renderRefList ? renderRefList(fx.references) : '') + '</details>';
  }
  return h;
}
...
function renderYikongSection() {
  ...
  if (yk.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献</summary>'
       + (window.renderRefList ? renderRefList(yk.references) : '') + '</details>';
  }
  // ── 法脉传承表 ──
...
function renderMimiSection() {
  ...
  if (mm.references) {
    h += '<details style=font-size:0.72em;margin-top:8px><summary>📚 参考文献</summary>'
       + (window.renderRefList ? renderRefList(mm.references) : '') + '</details>';
  }
  return h;
}