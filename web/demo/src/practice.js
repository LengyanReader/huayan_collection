...
function renderPractice(){
  ...
  var heartXRef={
    ...
    '闭气不是憋气':{r1:'◆ <b>参禅金钥匙·吸闭吐</b>: 第九讲详述——「吸(自然吸气)→闭(自然停住,不憋气)→吐(自然呼气),三个动作自然连贯。」本文是金钥匙「闭」字的准确诠释。<br>◆ <b>华严五祖·宗密《禅源诸诠集都序》</b>(CBETA T48n2015):「息妄者,非谓息灭其心,但令不起妄念而已。如水有波,波因风起;风息波停,水自澄净。」自然闭气恰如「风息波停」——非强力止波(憋气),而是风(用力)自息,水(呼吸)自澄。宗密以禅教融合之见,释「自然息妄」——与本文「自然闭气非憋气」完全互证。<br>◆ <b>数于尽处</b>: 在「息入尽」与「息出尽」的O点——即自然闭气之处数息。<br><span class=src>📎 禅观法要→参禅金三角·技术面数随止 · T48n2015 禅源诸诠集都序</span>',
      r2:'◆ <b>瑜伽·Kumbhaka(住气)</b>: 《哈达瑜伽之光》(Haṭha Yoga Pradīpikā) 2.44-47: Sahita Kumbhaka(有作住气)为刻意屏息,Kevala Kumbhaka(无作住气)为自然呼吸停止——无需用力,呼吸自然止息。后者与本文「自然闭气」完全一致。<br>◆ <b>道家·《庄子·大宗师》踵息</b>: 「古之真人……其息深深。真人之息以踵,众人之息以喉。」真人之息深至脚跟,闭气是深息的自然结果,非强制憋气。成玄英疏:「踵,足根也。真人息于踵,至深至细。」<br>◆ <b>道家·《老子》第10章</b>: 「专气致柔,能如婴儿乎?」柔和自然的呼吸如婴儿,闭气是柔和的延伸而非刚强的对抗。<br><span class=src>📎 《哈达瑜伽之光》Ch.2 ·《庄子·大宗师》成玄英疏 ·《老子》10章 · 辨喜《胜王瑜伽》:「呼吸是灵魂的飞轮,制息则心自制。」</span>'},
    ...
    '呼吸里的一股力':{r1:'◆ <b>工程面B阶段·洞悉呼吸因果轨迹</b>: 「明了的轨迹——清楚呼吸的因与果。掌握此即长寿法基础,法师称此为『生命的秘笈』。」本文「息之力」即B阶段所述呼吸因果轨迹的内在动力。<br>◆ <b>华严三祖·法藏《华严经义海百门》</b>(CBETA T45n1875):「了法无生,知法无我,则能所俱寂,心境双融。」息之「力」——当能感知到气息中的生命动能,即是从「法有我无」(初入禅观)转向「心境双融」(理事无碍)的关键转折。法藏以百门摄华严万象,一息之力即百门之一门。<br>◆ <b>般那不外漏</b>: 参禅金三角中保存息之「力」。<br><span class=src>📎 禅观法要→工程面B阶段·参禅金三角 · T45n1875 义海百门</span>',
      r2:'◆ <b>瑜伽·Prana(生命能量)</b>: 《泰迪黎亚奥义书》(Taittirīya Upaniṣad) 2.3: Prana由五种生命气息(Prāṇa命根气·Apāna下行气·Vyāna通行气·Udāna上行气·Samāna等住气)构成,遍布全身。瑜伽调息(Pranayama)即对Prana的调控——Ayama意为「扩展/控制」。本文「息之力」即Prana的直观体证。《哈达瑜伽之光》2.2:「当呼吸在动,心也在动;呼吸止,心亦止。」<br>◆ <b>道家·「炁」与先天之炁</b>: 《云笈七签》卷五十六:「炁者,天地之元,万物之始。」道藏《太上老君说常清静经》:「大道无形,生育天地。大道无情,运行日月。大道无名,长养万物。」此「大道」即是先天一炁——非口鼻呼吸之气(后天气),而是宇宙生命能量(先天炁)。与般那/息之力为同类概念。<br>◆ <b>中医·宗气与真气</b>: 《黄帝内经·灵枢》邪客篇:「宗气积于胸中,出于喉咙,以贯心脉而行呼吸焉。」<br><span class=src>📎 《泰迪黎亚奥义书》2.3 ·《哈达瑜伽之光》2.2 ·《云笈七签》56 ·《黄帝内经·灵枢》·《孟子·公孙丑上》「浩然之气」·《庄子·庚桑楚》</span>'},
