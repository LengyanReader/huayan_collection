...
function renderPractice(){
  ...
  var heartXRef={
    ...
    '置心一处':{r1:'◆ <b>置心一处·四种停心方法</b>: 《华严禅行法—禅观》:(1)参话头(2)置心风门(3)数息随息(4)依禅堂规矩。本文概为三大工程:调身(七支坐相)→调息(数息1-10)→调心(摄心于风门)。三者一体不二。<br>◆ <b>内摄·内观·禅观三层</b>: 内摄=技术面·摄心于风门;内观=感受法身存在(寂而常照·照而常寂·寂照双亡);禅观=粗→细→微妙。置心一处是内摄核心。<br><span class=src>📎 禅观法要→驻佇心观·四种停心方法·内摄内观禅观</span>',
      r2:'◆ <b>禅宗·《六祖坛经》定慧品(CBETA T48n2008)</b>: 「一行三昧者,于一切处行住坐卧,常行一直心是也。」「但行直心,于一切法勿有执著。」六祖批判「常坐不动,妄不起心」的枯坐——与本文「置心一处不是用力集中,而是身息心自然统一」的精神完全一致。<br>◆ <b>禅宗·《六祖坛经》无念法</b>: 「无念者,于念而无念。」「于诸境上,心不染,曰无念。」不是百物不思(那是法缚),而是念起不随——与本文置心一处后「不评判不懊恼」的态度一致。<br>◆ <b>天台·《小止观》系缘守境(CBETA T46n1915)</b>: 五种系缘法——系心顶上/发际/鼻柱(即风门)/脐间/地轮。引《禅门要略》:「系心在鼻柱者,鼻是风门,觉知息入息出。」与置心风门完全对应。<br>◆ <b>大乘·《大乘起信论》止观门(CBETA T32n1666)</b>: 马鸣菩萨:「若修止者,住于静处,端坐正意。不依气息,不依形色…一切诸想,随念皆除,亦遣除想。」此为「唯心识观」之置心一处的义理根源。<br>◆ <b>道家·《庄子·达生》佝偻承蜩</b>: 「虽天地之大,万物之多,而唯蜩翼之知。吾不反不侧,不以万物易蜩之翼,何为而不得!」——置心一处,天地不管,只管那一个目标。<br>◆ <b>儒家·《中庸》</b>: 「道也者,不可须臾离也;可离非道也。」「致中和,天地位焉,万物育焉。」诚之者,择善而固执之——专注一处的儒家版本。<br><span class=src>📎 CBETA T48n2008 定慧品 · T46n1915 系缘 · T32n1666 ·《庄子·达生》·《中庸》</span>'},
