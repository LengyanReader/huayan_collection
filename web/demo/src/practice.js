...
function renderPractice(){
  ...
  var heartXRef={
    ...
    '入禅九阶':{r1:'◆ <b>体系总览·三阶段</b>: 资粮道→前行→正行。入禅九阶涵盖资粮道至前行初期。<br>◆ <b>华严初祖·杜顺《五教止观》五重次第</b>(CBETA T45n1867): 法有我无门(小教)→生即无生门(始教)→事理圆融门(终教)→语观双绝门(顿教)→华严三昧门(圆教)。此五重止观是华严宗最古典的修行进路——九阶中暖身至入禅属「法有我无门」至「事理圆融门」的实操对应。<br>◆ <b>华严二祖·智俨《搜玄记》</b>(CBETA T35n1732): 开华严观行之先河,立「十玄门」以明事事无碍,九阶入禅后之继续深入对应「同时具足相应门」「因陀罗网境界门」。<br>◆ <b>华严三祖·法藏《金师子章》十门</b>(CBETA T45n1880): 明缘起→辨色空→约三性→显无相→说无生→论五教→勒十玄→括六相→成菩提→入涅槃——十门与海云入禅九阶有平行的修行进路逻辑。<br>◆ <b>华严四祖·澄观</b>: 历七帝之师,著《华严经疏》六十卷。五祖宗密《原人论》判教:人天教→小乘教→大乘法相教→大乘破相教→一乘显性教——与杜顺五教止观互为补充,同为华严修行阶次之古典框架。<br>◆ <b>宋代·子璿(长水)</b>: 《起信论疏笔削记》以华严释起信。「知止观双运,定慧均等,乃能入道。」<br>◆ <b>宋代·净源</b>: 「法界为宗,缘起为体,圆融为相,无尽为用。」宋代华严中兴之祖。<br><span class=src>📎 T45n1867 五教止观 · T35n1732 搜玄记 · T45n1880 金师子章 · 澄观《华严经疏》· 宗密《原人论》· 子璿·净源</span>',
