...
function switchPracticeView(view,btn){
  ...
  // Re-render mermaid diagrams (they fail when hidden)
  if (typeof mermaid !== 'undefined') {
    setTimeout(function(){ mermaid.run({querySelector:'.mermaid'}); }, 200);
  }
...
function renderChanTraces() {
  ...
  h += '<div class=mermaid style="max-width:100%">\ngraph TD\n  BODHI[佛陀灵山拈花] --> INDIA[印度28代]\n  INDIA --> DAMO[菩提达摩?-536]\n  DAMO --> HUIKE[慧可487-593]\n  HUIKE --> SENGCAN[僧璨?-606]\n  SENGCAN --> DAOXIN[道信580-651<br/>东山法门]\n  DAOXIN --> HONGREN[弘忍601-674]\n  HONGREN --> SHENXIU[神秀606-706<br/>北宗渐悟]\n  HONGREN --> HUINENG[慧能638-713<br/>南宗顿悟]\n  HUINENG --> NANYUE[南岳怀让]\n  HUINENG --> QINGYUAN[青原行思]\n  NANYUE --> MAZU[马祖道一709-788<br/>洪州宗]\n  QINGYUAN --> SHITOU[石头希迁700-790]\n  MAZU --> LINJI[临济义玄?-867<br/>临济宗]\n  SHITOU --> CAODONG[洞山良价+曹山本寂<br/>曹洞宗五位君臣]\n  MAZU --> WEIYANG[沩仰宗圆相默契]\n  SHITOU --> YUNMEN[云门文偃864-949<br/>云门宗]\n  SHITOU --> FAYAN[法眼文益885-958<br/>法眼宗]\n  LINJI --> DAHUI[大慧宗杲1089-1163<br/>看话禅]\n  CAODONG --> HONGZHI[宏智正觉1091-1157<br/>默照禅]\n  LINJI --> CHANJING[明清禅净合流<br/>念佛是谁]\n  CHANJING --> XUYUN[虚云1840-1959<br/>兼祧五宗]\n  XUYUN --> JINGHUI[净慧1933-2013<br/>生活禅]\n  XUYUN --> BENHUAN[本焕]\n  XUYUN --> FOYUAN[佛源]\n</div>';
...
function renderChengguanSection() {
  ...
  h += '<div class=mermaid style="max-width:100%">\ngraph TD\n  subgraph 天台宗[Tiantai]\n    DX[谛闲大师] --> XM[显明老和尚\\n天台45世]\n    XM --> CG1[成观法师\\n天台46世\\n1988年纽约出家]\n  end\n  subgraph 真言宗[Shingon]\n    KYS[高野山金刚峰寺] --> CG2[成观法师\\n真言宗53世\\n传法灌顶阿阇梨\\n1996年]\n  end\n  subgraph 华严宗[Huayan]\n    DS[杜顺至宗密五祖] --> LJ[历代祖师]\n    LJ --> CG3[成观法师\\n贤首宗42世\\n慈恩宗42世\\n2010年承接]\n  end\n  CG1 --> JY[新逍遥园译经院\\n1991年\\n台北]\n  CG1 --> BZS[遍照寺\\n美国密西根]\n  CG1 --> LY[楞严座主\\n楞严经义贯上下]\n  CG1 --> WS[唯识系列\\n百法/三十论/八识]\n  CG1 --> ZY[译经11种\\n英译法华/楞严/金刚/坛经]\n  CG1 --> ZM[真言密法\\n汉传东密]\n</div></div>';
