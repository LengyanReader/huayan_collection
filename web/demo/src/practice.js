...
function renderChengguanSection() {
  ...
  h += '<div class=mermaid style="max-width:100%">\n' +
    ...
    '    XM --> CG1["成观法师 天台46世 1988年出家"]\n' +
    '  end\n' +
    '  subgraph B["真言宗 Shingon"]\n' +
    '    KYS["高野山金刚峰寺"] --> CG2["成观法师 真言宗53世 1996年"]\n' +
    '  end\n' +
    '  subgraph C["华严宗 Huayan"]\n' +
    '    DS["杜顺至宗密五祖"] --> LJ["历代祖师"]\n' +
    '    LJ --> CG3["成观法师 贤首宗42世 2010年"]\n' +
    '  end\n' +
    '  CG1 --> JY["新逍遥园译经院 1991 台北"]\n' +
    '  CG1 --> BZS["遍照寺 美国密西根"]\n' +
    '  CG1 --> LY["楞严座主 楞严经义贯"]\n' +
    '  CG1 --> WS["唯识系列 百法 三十论 八识"]\n' +
    '  CG1 --> ZY["英译11种 法华 金刚 坛经"]\n' +
    '  CG1 --> ZM["真言密法 汉传东密"]\n' +
    '</div></div>';
...
(function(){
  setTimeout(function(){
    ...
    if(sub&&['system','meditation','news','resources','chan_traces','chengguan'].indexOf(sub)>=0){
