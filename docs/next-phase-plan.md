...
## L.76 《〔待核〕收尾 · P1 全批一手核实并挂链》（2026-09-25）

> 承 L.74/L.75  backlog P1 层——大正藏常见号 13 项，逐条经 WebSearch 查 CBETA/大正藏目录/学术论文脚注 一手核实 title↔number 后挂链。
- **般若空宗 L300–303**：中论 **T30n1564**、十二门论 **T30n1568**（非 1565！）、百论 **T30n1569**、吉藏四疏（**T45n1852**·**T42n1824**·**T45n1853**·**T45n1854**）、明句论汉译（《般若灯论释》**T30n1566**）；**七十空性论/回诤论** 及入中论/中观庄严论 无大正藏汉译单行/未确号 → 保持〔待核〕。
- **杜顺 L332/L339/L347**：出三藏记集 **T55n2145**、游心法界记 **T45n1877**、发菩提心章 **T45n1878**（原P0降级项经核实确认编号正确，正名回归）、宋高僧传 **T50n2061**。
- **宗密 §13.3**：宋高僧传 **T50n2061**、景德传灯录 **T51n2076**。
- **法相 L335**：唯识三十论颂 **T31n1586**。
- **智俨 L416**：金刚般若波罗蜜经略疏 **T33n1704**。
- **验证**：build 34 files｜**23,352,160 B**（+147 B·16 条新链净增）＋verify ALL PASSED＋test_pipeline ALL TESTS PASSED；grep 5 篇 HTML（master-dushun / master-zongmi / master-zhiyan / faxiang / yikong）确认 16 个 `zh/Txxxx` 模式各=1。backlog §B 标 ✅。

## L.75 《〔待核〕收尾 · P0 层清账（姊妹正稿已核号落链·1 项主动降级）》（2026-09-24）

> 承 L.74 backlog，清 **P0 层**（经号已在同源 YAML／姊妹正稿一手核、仅差落链者）。挂链前仍逐一**读源文件确认**，不凭记忆。
- **宗密综述 §13.1 复核**：确认 **T45n1886＝《原人论》**、**T45n1884＝《注华严法界观门》**（后者杜顺稿 L341 亦已渲染）。
- ✅ **三十九品 L426** 宗密《华严原人论》挂 **T45n1886**（standalone → `huayan-studies.html`，grep `zh/T45n1886`＝1 渲染为真）。
- ✅ **善财 L435** 宗密《注华严法界观门》挂 **T45n1884**（善财稿**未被 build 摄取**→ md 即交付，无 HTML 项可验）。
- ⬇️ **P0 第 3 项主动降级**：杜顺稿 L339《游心法界记》《发菩提心章》——复查发现我在 L.74 所注「T1877/T1878」实为**推测**（法藏稿 §一 与同源 YAML 并无此二文已核号），按「不臆造」铁律**撤挂、降入 P1**，backlog §A/§B 已订正留痕。**此举正是 batch7 教训的正向复现：宁降级，不凭记忆落链。**
- **验证**：build 34 files｜**23,349,417 B**（较上 +107·系三十九品新链，善财未摄取故零增）＋verify ALL PASSED＋test_pipeline **ALL TESTS PASSED**。**commit 不 push**（推送待用户明示）。

## L.74 《进度沉淀 · 建〔待核〕收尾 backlog（全量清点·分优先级·可接续）》（2026-09-24）

> 应用户「记录进度 + 把后续未核验的都记下来」——对 `docs/*.md` 全部 〔待核/待采/按名检/t.b.v〕 标记做**全量清点**（一次扫描 342 处命中），剔正文论证内之审慎存疑（非待办），将**文末参考文献区**尚缺可回查直链者沉淀为独立清单：**`docs/文献待核_backlog.md`**。
- **分级**：P0（同源 YAML／姊妹正稿已一手核·仅差落链，如三十九品 L426 宗密《原人论》→T45n1886、善财 L435《注华严法界观门》→T45n1884）｜P1（大正藏常见号·查目录即定：出三藏记集/宋高僧传/景德录/中论百论十二门论/唯识三十颂…）｜P2（卍续藏·密教·跨册号：文殊五单号/法藏 T1846 等跨册·宗密圆觉诸疏册号/天台三大部〔`tiantai_juejing.yaml` 零 sigla·整批待查〕/密宗大日金刚顶…）｜P3·P4（近现代学报页·[本宗]/网络/藏品回链）｜P5（各文档〔待采〕近年研究反哺位摘要，海云/梦参「教外学术基本阙如」为结构性缺口）。
- **边界**：清单首尾各置「铁律」（不臆造·CBETA 系 JS 单页须经数位典藏目录一手复核）与「勿误清」附注（`佛门真伪`/`禅法传统`/`识与心灵`二篇/`澄观`正文内〔存疑〕系认识论标注，不入待办）。已闭合项（L.73 金师子章·百法明门论）列于 §F 留痕。
- **本会话净进度**：Phase 3 收官（已 push）＋QA 一手复核（commit d7bcb27 未 push·领先 1）＋本 backlog 建档。
- **验证**：新增 `docs/文献待核_backlog.md`（80 行）·删除临时扫描文件；不影响 build 产物（backlog 非摄取文档）。

## L.73 《Phase 3 后审 · 〔待核〕收尾一手复核（已验证者即收·其余存疑）》（2026-09-24）

> 应用户「只收已验证的·即停」——对 Phase 3 遗留之 CBETA 〔待核〕经号，凡能经**一手目录（CBETA／《大正藏》数位典藏）复核**者即挂链并改正，无从即时核证者保持〔待核〕诚实边界，不逐条深挖。
- **法藏·金师子章（勘正本人前批误注）**：一手确认 **No.1880=宋·净源《金师子章云间类解》**、**No.1881=唐法藏撰·宋承迁注《华严经金师子章注》（内合法藏本文）**——本文原著录本即正确，batch7 拙加「本项目 YAML 以 T45n1880 为本文」之〔存疑〕按语**系本人失察**（该 YAML 主张并不存在；`frontier_dialogue.yaml` 反以 T45n1881 标之）。今撤误注、两号各挂 CBETA 直链（`/zh/T45n1880`·`/zh/T45n1881`）。
- **法相·百法明门论**：一手确认 **T31n1614·世亲（天亲）菩萨造·唐玄奘译** → 挂直链；**并正原文「龙树/提婆」作者归属之误**（加按留痕）。《唯识三十论颂》独立号本轮未及核（检索中止）→ 维持〔待核·颂文即摄于成唯识论 T31n1585〕之安全表述。
- **未处理（存疑·留后续专题）**：唯识三十论颂独立号／文殊普贤密教单号（T1196·1167·1177B·230·178 册次）／宗密《圆觉经》诸疏卍续藏册号／天台·密宗原典（`tiantai_juejing`·`mimi_daodi` YAML 无已核 sigla）——均**宁缺不伪**，保持〔待核〕〔按名检〕。
- **验证**：build 34 files｜**23,349,310 B**＋verify/test ALL PASSED；grep `master-fazang.html`（`zh/T45n1881`·`zh/T45n1880` 各 1）、`faxiang.html`（`zh/T31n1614`·`世亲（天亲）` 各 1）均渲染为真链。**commit 不 push**（遵既定：推送待用户明示）。

## L.72 《Phase 3 收官 · 孤立旧稿《圭峰宗密与其身后…0.md》比对后处置》（2026-09-24）

> 依用户抉择「比对后合入正稿再删」（同 L.66 华严宗二祖研究.md 之处理法）。对 `docs/圭峰宗密与其身后全方位文献综述0.md`（1545 行）与已摄取正稿《圭峰大师宗密全方位文献综述.md》（zongmi review_doc → `articles/master-zongmi.html`）逐层比对。
- **摄取状态**：0.md **全域零引用**（yaml/py/js/html/md 除本计划外无一处指向）·**无任何 build 摄取路径**·**无征引目/参考文献区**。系早期工作草稿。
- **内容比对（客观差集）**：① 0.md **大正/卍续 sigla = 0**（正稿 §13 有 5 号）→ 无可折入之新经号；② `《》`题名差集 10 项，逐一溯源**皆为裴休碑异名/常见经名/或正稿已载**（白居易〈赠草堂宗密上人〉「口藏宣传十二部」正稿 L148/L248、刘禹锡〈送宗密上人归草堂寺…〉L149/L248）；③ 学者名差集 **0**；④ 年号差集仅 780/800/839年——澄观卒 839（正稿 §2.4 L129/L190 更附【考】生卒异说）、约800 求法（正稿 §1.4 编年）、甘露之变《旧唐书》「遇苦即救·死固甘心」全文（正稿 §3.5 L309–L346）、会昌 842–846（正稿 §3.7/§10.1 L152/L358/L376/L937）**皆已涵盖且更详**。
- **结论**：正稿系 0.md 之**严格超集**，0.md **无任何独有史实/引据/参考**可合入（异于 L.66 尚存 3 条独有参考）——「合入」步骤得空集，遂**径删孤立旧稿**。删后确认全域 `宗密与其身后…0` 引用 0。
- **验证**：0.md 未被摄取，删除不动 build 产物；`build.py` 34 files｜23,347,394 B 不变、verify/test ALL PASSED（卫生复跑）。
- **Phase 3 收官**：`ref=True` 收尾书目 10 篇（批1–5）＋ PLAIN 升级 7 篇（法藏/澄观/三十九品/善财/文殊普贤/Chan-EN/宗密勘漏）＋「延伸阅读」升级 5 篇（三十七道品/法相/般若/密宗/天台）＋ 旧稿去重 2（智俨·宗密）＝**全部完成**；七篇注入式祖师 review_doc（杜顺/智俨/法藏/澄观/宗密/李通玄/梦参）分级+CBETA 齐备。
- **⚠ 提交/推送纪律**：本机对 github.com **TCP 443 出站被阻断**（ICMP 可达·HTTPS 连接超时 300s）——batch7–12 累计 commit 全在本地 `main`（领先 origin 6），待网络恢复一次性 `git push origin main`。commit 照做，push 遇网阻如实上报不隐瞒。
...
- **法藏**：§八 总表加**分级图例**＋ `[A/B/C]` 标签＋**确定性 CBETA 直链**（仅对已与 `dushun_wujiao_zhiguan.yaml`／智俨正稿交叉印证者：T35n1733 探玄记、T45n1866 五教章、T51n2073 传记、T50n2054 法藏传、T49n2035 佛祖统纪）。**⚠ 发现 title↔number 归属差异**：本文以 T1880=《云间类解》、T1881=《金师子章》，而已核 YAML 以 T45n1880=法藏《金师子章》本文——故两号均标〔待核〕、不强挂直链、以存其疑（不臆造）。跨册诸疏（起信论义记 T1846 等）部册未逐一复核一律〔待核〕。英文区已有 2019–2025 近研（Jones OUP 2025、Connelly 2025、de Vries 2024、Hammerstrom 2020、Nakasone 2022），量足，改置「近年研究说明」免〔待采〕。
- **澄观**：§九 原典区**已写定完整「册+部号」sigla**（T35n1735／T36n1736-1738／T45n1882-1885／T51n2076／T49n2035-2037／T50n2061）→ 全部按号确定性拼接为 CBETA 直链（零手抄新号）；X03n0221 用本文原附 URL，X58n1005 及《贞元疏》《十八问答》标〔待核〕。
- **验证**：build 34 files｜23,327,737 B＋verify ALL PASSED；grep `master-fazang.html`（信度分级 1／zh-T35n1733 实链 1）与 `master-chengguan.html`（信度分级 1／确定性拼接 1／zh-T35n1735·zh-T49n2037 各 1）均渲染为真 `<a href>`。
- **提交纪律**：commit `26b9bcc` 不 push。p3plain 余：华严经学三十九品／善财五十三参／文殊普贤信仰／Chan-EN（4）；p3none 6 篇待新建书目。

## L.66 《Phase 3 · 旧稿合并去重：华严宗二祖研究.md → 正稿》（2026-09-24）

> 依用户抉择「合并进正稿」。经比对：正稿《华严宗二祖智俨_综合深度研究》系旧稿《华严宗二祖研究》之**严格超集**（多出"四·著作全录""六·核心教理""七·观行视觉""九·历代评价"等章，旧稿对应主题为简版）。旧稿**唯一独有物**为 3 条参考文献 → 已折入正稿书目：① 郭磊〈新罗义相及其"法界缘起"之华严思想〉[B]；② 袁大勇〈论《大乘起信论》在法藏五教—四宗判教体系中的地位〉[B]；③ 木村清孝先学访谈〈先学に聞く 第4回〉[B]（魏道儒〈从《华严十玄门》解析佛学中国化〉正稿已有，未重复）。旧稿正文诸章为正稿更详版所涵盖，不并回以免同源分歧。
> **删除** `docs/华严宗二祖研究.md`：删前核验其**未被任何引用**——nav 之「智俨·二祖」指向 `articles/master-zhiyan.html`；`huayan_masters.yaml` 之 zhiyan `review_doc` 指向**正稿**；web/src/scripts 全域无 `华严宗二祖研究` 命中。
- **⚠ 重要更正**：`*综合深度研究.md` 系**经 `huayan_masters.yaml` `review_doc` 被 build.py 摄取、注入 `articles/master-*.html`**（杜顺/智俨/李通玄/宗密[综合]均然）——前数批"md 非 build 摄取源、无需 DOM 核验"之表述有误；好在编辑皆为 markdown 正文＋链接，注入即随文章页渲染，无结构性风险。
- **验证**：build 34 files｜23,301,529 B＋verify/test ALL PASSED；grep 生成后的 `master-zhiyan.html` 命中「分级 · 🔗 可回查」「CBETA T35n1732」「袁大勇」「木村清孝先学访谈」各 1、`华严宗二祖研究` 0 残留。
- **提交纪律**：commit 不 push。**后续 `ref=False` 文档新建书目＝"登记内联引证＋主线 WebSearch 补 2–3 条 2015–2026 近年研究（不可核证标〔待核〕）"**（用户既定）。因这些 md 多经 review_doc 进 articles，完成后一律 grep 生成的 `master-*.html` 复核渲染。

---

## L.65 《Phase 3 批量·五 · 识与心灵 二篇多语对读（CBETA 链接修复 + 分级图例）》（2026-09-24）

> 二篇系本项目**最大**多语对读文档（唯识学×意识科学/心理学），已自带完整学术著录 + 中英 mirror 块，唯**CBETA 链接 sigla 非规范**：全文以裸号 `cbetaonline.dila.edu.tw/zh/T1585`（缺卷次，点击 404）书写。**修复**＝据各条自带"第N册No.XXXX"著录（俱舍29/中论·瑜伽30/成论·二十·摄论31/述记43/八识·金师子45/止观46/坛经·都序48，纯确定性、零新号），脚本 `scripts/_tmp_fix_cbeta.py`（用后即删）将**84 处**（意识科学篇 66 + 心理学篇 18）裸号规范化为 `T{册}n{号}`；断言：无残留裸号、总链接计数不变、unknown 号集为空。
> **分级图例**：两篇 `## 参考文献` 下各加一行 **[A]/[B]/[C] + CBETA 约定**（正文实质已 template-grade，不重排 mirror 块以免扰动中英对读）。
- **验证**：临时脚本 assert 全绿；`build.py`（34 files）＋verify_demo／test_pipeline ALL PASSED（md 非 build 摄取源，跑作卫生检查）。
- **提交纪律**：commit 不 push。**Phase 3 `ref=True` 收尾书目全部 10 篇已升级完毕**；余 `ref=False`（须**新建**收尾书目）：4 巨制文献综述（法藏463/澄观591/宗密859/宗密身后977）+ 8 全方位研究（天台/密宗/法相唯识/般若中观/三十七道品/文殊普贤/善财340/华严经学三十九品303）+ 禅法诸篇（Chan Traditions 216/六祖以外215/禅法中英对读714）+ 佛门真伪812——为 Phase 3 剩余重头。

---

## L.64 《Phase 3 批量·四 · 华严宗二祖研究（旧稿）+ ref海云继梦法师》（2026-09-24）

> - **华严宗二祖研究.md**：系正稿《华严宗二祖智俨_综合深度研究》之**早期近重复稿**（同为七章+参考段）。原典此处无内联经号 → 挂链仅取"本文/已核验 YAML/姊妹篇已核定著录"三源交集（T35n1732／T45n1868·1869·1870·1866／T35n1733／T45n1880／T51n2073），金刚略疏·文义纲目·义湘·一然·崔致远无号→〔待核〕；分层中/日/英。**⚠ 待用户决：此旧稿是否宜与正稿合并去重（现为两份并存）。**
> - **ref海云继梦法师_佛法修行体系研究.md**：**当代法师研究特例**——来源几全属教团官网/讲记/网络，无 CBETA/学术一手。保留条目原文，逐条映射 **[本宗·一手]**（大华严寺官网+讲记开示）、**[B]**（社科院报道）、**[C·线索]**（维基/百度/电子书简介/知乎），大华严寺挂 huayenworld.org 站根；**新增"学界研究缺口"反哺位**（独立于教内认信的世俗学术专题研究阙如）。
- **铁律守住**：只登记去重·不改正文；书目/URL 全保留；CBETA 仅用三源交集经号，无号〔待核〕；当代/本宗文档用 [本宗] 层不硬塞学术分级。
- **验证**：docs/ 独立研究文档，非 build 摄取源 → 无需 DOM 核验；文件级 diff 逐条复核无误。
- **提交纪律**：commit 不 push。**Phase 3 md 已 8 篇**（+二祖研究旧稿·海云继梦）。下一步：`识与心灵`二篇多语对读（大篇，ref=True 已有收尾书目→轻改）；再进入 `ref=False` 重头（4 部巨制文献综述 + 8 部全方位研究 + 禅法诸篇 + 佛门真伪）——须从内联引证**新建**收尾书目。

---

## L.63 《Phase 3 批量·三 · 圭峰宗密 + 梦参老和尚 综合深度研究.md》（2026-09-24）

> 续做两篇（`ref=True`）。
> - **圭峰宗密**：原典仅《禅源都序》T48n2015（已核验）挂 CBETA 🔗，余（原人论/圆觉大疏·钞·略疏/承袭图/宋高僧传/景德录/续法/知讷修心诀）无号 → 〔待核〕；现代论著分中/日/英/**法**四域（冉云华·董群·Gregory·Broughton·镰田·Demiéville = [A]；会议论文 [B]；宗教学术网/光明网 [C]）；大华严寺网站归 **[本宗/B·入口]**；新增"近年可补线索"（Broughton 后新论·敦煌/和刻本·藏传敦煌视角）。
> - **梦参老和尚**：**近现代僧传特例**——来源以教团官方/自述/佛学媒体为主，**保留原五段条目全不动**，仅补图例 + 五标题映射分级（道场官方·自述 = **[本宗]**、出版方 = **[B]**、佛教媒体整理 = **[C·线索]**、本仓库数据 = 内部源）；**新增"六、学界研究缺口"反哺位**（独立于教内认信的世俗学术专题研究基本阙如，为最大结构性缺口）。
- **通用铁律守住**：只登记去重·不改正文；书目/卷期/URL 全保留；CBETA 仅用已核验经号，无号一律〔待核〕；本宗/近现代文档不强塞学术分级、改用 [本宗] 层。
- **验证**：docs/ 独立研究文档，非 build 摄取源 → 无需 DOM 核验；文件级 diff 逐条复核无误。
- **提交纪律**：commit 不 push。**Phase 3 md 批量已 6 篇**（杜顺·智俨·李通玄·永嘉·宗密·梦参）。余：`ref=True` 轻改 3（华严宗二祖研究/ref海云继梦/识与心灵×2）；`ref=False` **需从内联引证新建收尾书目**（4 部巨制文献综述 法藏·澄观·宗密·宗密身后 + 8 部全方位研究 + 禅法诸篇 + 佛门真伪问题）为后续重头。

---

## L.62 《Phase 3 批量·二 · 李通玄长者 + 永嘉玄觉大师 综合深度研究.md》（2026-09-24）

> 续做两篇（均五祖/关键人物系列、`ref=True`）。
> - **李通玄**：原典绝大多数仅题名无经号 → 仅《新华严经论》T36n1739、《佛祖统纪》T49n2035（本系列共享 dushun YAML 已核验）挂 CBETA 🔗，余（略释决疑论/合论/宋高僧传/通载/要解/简要/纂要/知讷节要）一律〔待核〕不臆造；现代论著分 [A 周叔迦·稲岡印仏研·镰田·Gimello/Gregory/Cook/Koh·Park] / [B 学位论文·会议] / [C 中新网]；分中/日/英/**韩**五域；新增"近年可补线索"（Koh/Park 后英文新论、知讷—李通玄东传韩研、点校本版本补全）。
> - **永嘉玄觉**：原文档**已自带完整可点 CBETA 🔗**（T48n2014·2013·2008、T50n2061、T51n2076、T49n2035、卍续 X0586·X1513 均文内自证）→ **保留全部链接不动**，仅补分级徽标 + 图例；首开 **[本宗]** 层（常空《月映千江》、南怀瑾讲述=禅门自述讲记，不纳学术分级）；英译接受史富（Jia/Hongzhou、Muller BDK、Suzuki/Luk/Red Pine/Park/Hershock）；"近年可补线索"点明**日文学界缺口**（本文自陈）。
- **通用铁律守住**：只登记去重、不改正文；书目/卷期/ISBN/URL 全保留；CBETA 仅用已见本文或已核验 YAML 之经号，存疑/无号一律〔待核〕。
- **验证**：docs/ 独立研究文档，非 build 摄取源 → 无需 DOM 核验；文件级 diff 逐条复核无误。
- **提交纪律**：commit 不 push。此后 `圭峰宗密_综合深度研究`(201)、`梦参老和尚`(184) 与体量巨大的 `*全方位文献综述*`（法藏463/澄观591/宗密859/宗密身后977，均 ref=False·内联引证）待续。

---

## L.61 《Phase 3 批量·一 · 华严宗二祖智俨_综合深度研究.md》（2026-09-24）

> 用户验收样板并明确 push（`4e78094..928a636`，本地=origin）后进入批量。第一篇＝**智俨**（五祖系列、与杜顺同源）。原 §参考文献已有内联 T 号（T35n1732／T45n1868·1869·1870／T51n2073／T50n2060·2054）→ 逐条转 **[A]+🔗 CBETA**；法藏五教章/探玄记/金师子章取自已核验 YAML（T45n1866/T35n1733/T45n1880）；义湘/一然/续法/金刚略疏无经号在手 → 一律〔待核〕不挂链。现代论著分层 [A 通史·辞典·权威日著]/[B 学位论文·学报]/[C 青岛学报作者未确·网络百科]；SEP 挂条目页；新增"六、近年可补线索"反哺位。书目/卷期/出版社全保留，只登记去重不改正文。
- **验证**：docs/ 独立研究文档，非 build 摄取源 → 无需 DOM 核验；文件级 diff 复核无误。
- **提交纪律**：commit 不 push。下一批拟续做 李通玄长者／永嘉玄觉／圭峰宗密（综合深度研究，均 ref=True·同源易核）。

---

## L.60 《Phase 3 试点样板 · 杜顺综合深度研究.md 参考文献段升级为分级+🔗》（2026-09-24）

> 应用户批准（"可以"），选 `docs/华严宗初祖杜顺_综合深度研究.md` 作**首篇试点**（引证最密、与 Phase 2a 已核验的 `dushun_wujiao_zhiguan.yaml` 同源）。把原 §参考文献与资料来源说明（未分级·无链接）改造为模板体例：**①** 加信度分级 **[A]/[B]/[C]/[题·传]** 与 CBETA 约定说明；**②** 原典逐条挂 🔗 CBETA 可回查链接——**仅对经号已见于本文著录或 YAML（已核验）者**（T50n2060/T51n2073/T45n1867/T45n1868/T45n1866/T35n1732-35/T45n1880/T45n1883/T45n1884/T48n2015/T36n1739/T49n2035）， SEP 挂 https://plato.stanford.edu/entries/huayan-buddhism/；**③零臆造**：《法界观门》No.1876 经号存疑 → 标〔待核〕不自动挂链，续藏/宋高僧传/出三藏记集等部号未明者一律〔待核〕；**④** 现代论著按权威度分层（专著/通史 [A]、学报论文 [B]、佚名作者未核 [C]），网络百科归 [C·线索] 仅列站点性质；**⑤** 新增"近年可补线索"地图反哺位。**只登记去重、不改正文考辨**。原典书目、作者、卷期、ISBN 一律保留原文，未增删事实。
- **验证**：本 md 系 `docs/` 独立研究文档，非 build.py 摄取源（articles/master-dushun.html 为独立静态页；build 仅读文献综述/wechat md），故无需 DOM 核验；build（34 files｜23,232,899 B 不变）＋verify_demo／test_pipeline ALL PASSED。
- **提交纪律**：commit 不自动 push（本批 `ahead 7`）。**待用户验收样板后，再按同一法度逐篇扩容升级其余 20 篇 md 研究文档。**

---

## L.59 《Phase 3 起手 · 分级参考文献_模板.md（体例骨架）》（2026-09-24）

> 应用户选择：**总方向=模板+全面扩容升级**；**起手=先只做模板骨架、验收后再批量套用 21 篇 `docs/*研究/*.md`**。

- **产出**：`docs/分级参考文献_模板.md`——统一收尾体例（**三条铁律**：绝不臆造 / CBETA 确定性拼接·经号须已见于本文或数据·不手抄新号 / 本宗自述不纳分级）+ **三级信度** [A]/[B]/[C]/[本宗] + **五域框架** + 条目行式 + **可复制收尾区**（markdown 代码块）+ **套用验收清单** + **与 YAML `references` 同源反哺**指引。
- **同构性**：体例与 `common.js: renderRefList`（tier 徽标 + 🔗核对）及三份文献地图（禅门/华严/教海行云·即成图范例）完全对齐。
- **现状勘察**：21 篇研究 md 均将引证**内联正文**、缺统一收尾区；模板正是补此。篇目行数 812→101 不等，`圭峰宗密`(859/977)、`法藏`(463)、`澄观`(591)、`佛门真伪`(812) 为大篇。
- **待验收后启动**：批量套用（每篇：抽内联引证→归五域→打级→回溯一手才给🔗→补 2–3 条近年线索→存疑只回指数据）。粗估 4–6 批次、跨会话。
