...
- **考证**：persons 95/95 全有 source（0 缺源，T0 归零）；来源可靠性评分 68/100，T3 模糊来源 36 条待细化；`verified=1` 72/95（75.8%，㉖-㉘ 累计回填），`verified=0` 23 条均为无力考者并注明（菩提流支〔卒年诸说未定〕/大华严寺瑜伽行法脉及宗内谱系 6 人〔系派自述无独立史料〕/当代学者·法师〔无公开生卒〕）；生卒年 no_dates 双缺 17 条（古代译师与神话·集体人物本无考）、单缺 11 条；图谱 98 边/24 法系/30 地点（0 缺坐标、16 有 city）；文献 54 部（CBETA ID 12・大正藏编号 35）、41 品、50 术语、180 人地关联、15 文章页。遗留待核：source-audit T3 36 条细化、L-C 善财〔待核〕项余下 84000/CBETA 复核、L-B 专题定值复审未二轮。
- **中英结合**：人名 name_en 95/95（100%）・name_sa 30/95（32%，余 65 中文/日系名无梵文对应留空〔待核〕，玄奘/慧果两例考证已闭环）；术语表 50/50 条 term_en+definition_zh+definition_en 全覆盖、term_sa 32/50；经目 title_en 3/54・title_sa 6・title_bo 1（多语不全，后续补充）；数据层 `_en`/`en` 键：practice 1461・translation 103・cosmology 41・knowledge_graph 96・frontier 5・events 0（地理史料以拉丁文为主）；全站 6 Tab+15 文章页均带 `.en-line` 全局双语机制。遗留缺口：**Tab4 frontier 仅 5 节 intro_en、论文条目级无 EN（清单最薄）**、texts.title_en 3/54、person bio 级 EN 需 SQLite 增设列（考证优先暂不臆造）。
