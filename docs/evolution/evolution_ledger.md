...
|---|---|---|---|---|---|---|---|
| 67 | — | 🧠 | content_verify | P1全批16号一手核实挂链(般若/杜顺/宗密/法相/智俨) |  | ✅执行 |  |
...
| 44 | — | 🧠 | content_expand | Phase1 华严文献: 文献地图+avatamsaka_studies分级参考 | 新建docs/华严文献地图_五域近年.md; references 55→62条·7类·tier A/B/C·13可点U | ✅执行 |  |
| 45 | — | 🧠 | content_expand | Phase2a 教海行云·判教/止观核心 references 结构化 | huayan_panjiao(7)+dushun_wujiao_zhiguan(18): 3类映射+tier+CBETA | ✅执行 |  |
...
| 54 | — | 🧠 | template | Phase3批量: 圭峰宗密(都序T48n2015挂链,中英日韩法域)+梦参老和 | 第5-6篇; 零臆造; 本宗文档不强塞学术分级 | ✅执行 |  |
| 55 | — | 🧠 | template | Phase3批量: 华严宗二祖研究(旧稿,近重复待决去重)+ref海云继梦(当代 | 第7-8篇; 三源交集经号挂链零臆造 | ✅执行 |  |
| 56 | — | 🧠 | content_expand | 识与心灵×2: CBETA裸号sigla规范化(T1585->T31n1585等 | 链接修复;修前点击404 | ✅执行 |  |
| 57 | — | 🧠 | content_expand | 华严宗二祖研究旧稿合并入正稿(3条unique参考折入)+删除冗余旧稿 |  | ✅执行 |  |
| 58 | — | 🧠 | template | 法藏/澄观 全方位文献综述 参考文献总表升级为分级[ABC]+确定性CBETA直 |  | ✅执行 |  |
| 59 | — | 🧠 | template | 三十九品/善财五十三参/文殊普贤/Chan-EN 四篇参考文献升级分级+CBET |  | ✅执行 |  |
| 60 | — | 🧠 | template | 三十七道品全方位研究 延伸阅读升级为分级[ABC/本宗]+CBETA直链(取同源 |  | ✅执行 |  |
| 61 | — | 🧠 | template | 法相唯识/般若中观/密宗/天台 四全方位研究 延伸阅读升级为分级+CBETA(无 |  | ✅执行 |  |
| 62 | — | 🧠 | content_expand | 圭峰大师宗密全方位文献综述 §13 分级+CBETA 直链(勘漏补:zongmi |  | ✅执行 |  |
| 63 | — | 🧠 | content_expand | 删除孤立旧稿 宗密身后0.md(比对=正稿严格超集·无独有可合) |  | ✅执行 |  |
| 64 | — | 🧠 | content_verify | 〔待核〕收尾:金师子章T45n1880/1881核实+删误注;百法明门论T31n |  | ✅执行 |  |
| 65 | — | 🧠 | progress_log | 建文献待核_backlog.md:全量清点待核/待采/按名检·分P0-P5优先级 |  | ✅执行 |  |
| 66 | — | 🧠 | content_verify | P0清账:原人论T45n1886/注华严法界观门T45n1884据宗密§13.1 |  | ✅执行 |  |
